...
$sql_create_amazonia = "CREATE TABLE IF NOT EXISTS amazonia (
...
if ($conn->query($sql_create_amazonia) === FALSE) {
...
if (isset($_POST['recipe_name'], $_POST['ingredients'], $_POST['steps'], $_POST['cooking_time'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO amazonia (nombre, ingredientes, pasos, tiempo_coccion) VALUES (?, ?, ?, ?)");
